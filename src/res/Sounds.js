...
var Sounds = {
	...
	THANKS_FOR_CHOOSING_ME:          new SoundEntry(null, Strings.get("THANKS_FOR_CHOOSING_ME")),
	...
	LADDER_TREE_OOPS_TOO_HIGH:            new SoundEntry(null, Strings.get("LADDER_TREE_OOPS_TOO_HIGH")),
	LADDER_TREE_OOPS_TOO_LOW:             new SoundEntry(null, Strings.get("LADDER_TREE_OOPS_TOO_LOW")),
	LADDER_TREE_TRY_A_SMALLER_NUMBER:     new SoundEntry(null, Strings.get("LADDER_TREE_TRY_A_SMALLER_NUMBER")),
	LADDER_TREE_TRY_A_BIGGER_NUMBER:      new SoundEntry(null, Strings.get("LADDER_TREE_TRY_A_BIGGER_NUMBER")),
	LADDER_TREE_AGENT_SUGGEST_SOLUTION_1: new SoundEntry(null, Strings.get("LADDER_TREE_AGENT_SUGGEST_SOLUTION_1")),
	LADDER_TREE_AGENT_SUGGEST_SOLUTION_2: new SoundEntry(null, Strings.get("LADDER_TREE_AGENT_SUGGEST_SOLUTION_2")),
	LADDER_TREE_BETTER_BECAUSE_BIGGER:   new SoundEntry(null, Strings.get("LADDER_TREE_BETTER_BECAUSE_BIGGER")),
	LADDER_TREE_BETTER_BECAUSE_SMALLER:    new SoundEntry(null, Strings.get("LADDER_TREE_BETTER_BECAUSE_SMALLER")),
	LADDER_TREE_AGENT_PLAY_TOO_LOW:         new SoundEntry(null, Strings.get("LADDER_TREE_AGENT_PLAY_TOO_LOW")),
	LADDER_TREE_AGENT_PLAY_TOO_HIGH:   new SoundEntry(null, Strings.get("LADDER_TREE_AGENT_PLAY_TOO_HIGH")),
	LADDER_TREE_AGENT_SEE_CORRECT:        new SoundEntry(null, Strings.get("LADDER_TREE_AGENT_SEE_CORRECT")),
	
	LADDER_MOUNTAIN_IM_DOWN_HERE:    new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_IM_DOWN_HERE")),
	LADDER_MOUNTAIN_IM_UP_HERE:      new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_IM_UP_HERE")),
	LADDER_MOUNTAIN_TRY_FEWER_BALLOONS: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_TRY_FEWER_BALLOONS")),
	LADDER_MOUNTAIN_TRY_MORE_BALLOONS: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_TRY_MORE_BALLOONS")),
	LADDER_MOUNTAIN_AGENT_SUGGEST_SOLUTION_1: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_AGENT_SUGGEST_SOLUTION_1")),
	LADDER_MOUNTAIN_AGENT_SUGGEST_SOLUTION_2: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_AGENT_SUGGEST_SOLUTION_2")),
	LADDER_MOUNTAIN_BETTER_BECAUSE_BIGGER: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_BETTER_BECAUSE_BIGGER")),
	LADDER_MOUNTAIN_BETTER_BECAUSE_SMALLER: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_BETTER_BECAUSE_SMALLER")),
	LADDER_MOUNTAIN_AGENT_PLAY_TOO_LOW: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_AGENT_PLAY_TOO_LOW")),
	LADDER_MOUNTAIN_AGENT_PLAY_TOO_HIGH: new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_AGENT_PLAY_TOO_HIGH")),
	LADDER_MOUNTAIN_AGENT_SEE_CORRECT:        new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_AGENT_SEE_CORRECT")),
	
	LADDER_MOUNTAIN_YOU_SAVED_ME:    new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_YOU_SAVED_ME")),
	LADDER_MOUNTAIN_IM_HUNGRY:       new SoundEntry(null, Strings.get("LADDER_MOUNTAIN_IM_HUNGRY")),
